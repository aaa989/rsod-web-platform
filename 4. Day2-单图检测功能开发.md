...
| 接口 | 方法 | 参数 | 说明 |
|------|------|------|------|
| `/detection/single` | POST | file, model_name | 单图检测 |
...
|--------|------|------|------|
| file | File | 是 | 图片文件 |
| model_name | String | 否 | 模型名称，默认 pest-v1 |
...
```json
{
  ...
  "message": "检测成功",
  "data": {
    "detection_id": "2661a97d-ec43-4cd9-a906-ce93938421c7",
    "image_url": "/static/uploads/temp_03db2295ca264ec3b58f2f5524c3e414.jpg",
    "result_image_url": "/static/results/result_f520fa7f2b7943b4929555fd64fd685d.jpg",
    "boxes": [
      {
        "x1": 3.83,
        "y1": 229.36,
    ...
    "total_objects": 5,
    "detection_time": 0.368,
    "model_name": "pest-v1",
    "created_at": "2026-05-15T01:33:21.328665"
  }
}
```
